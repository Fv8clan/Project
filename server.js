...
client.on('message', nezuko => {
    if (nezuko.author.bot) return;
    if (nezuko.isMentioned(client.user))
    {
      nezuko.reply("**My Prefix is ``-`` **")
    }
    });
...
client.on("message", async message => {
    ...
    } else if (message.content.startsWith("04dkfsdspgorp")) { ///لاتعدل في هاذي
        let args = message.content
            .split(" ")
            .slice(1)
            .join(" ");
    ...
    } else if (message.content.startsWith("yulfhjkdyljdy;fylfy")) {
        let args = message.content
            .split(" ")
            .slice(1)
            .join(" ");
...
${prefix}invites > رؤية عدد دعواتك

${prefix}members > رؤية حالات الاعضاء

${prefix}autorole <rolename> >اضافة رتبه تلقائية عند دخول العضو

${prefix}infoautorole > autorole معلومات عن 

${prefix}user > معلومات الشخص

${prefix}avt > رؤية الصورة الشخصية الخاصة بك

${prefix}avatar <ID Member> >رؤية الصورة الخاصة باحد الاعضاء عن طريق الايدي (الهوية الشخصية)

${prefix}colors > رؤية الألوان المتوفرة

${prefix}color > اختيار احد الالوان

${prefix}link > انشاء رابط لسيرفرك في الخاص

**|  Command Admin  |**

${prefix}clear > حذف الرسائل من الروم

${prefix}ban > حظر العضو
 
${prefix}kick > طرد العضو

${prefix}lock >  اقفال الروم

${prefix}unlock > فتح الروم

${prefix}mute > كتم العضو

${prefix}unmute > الغاء كتم العضو

${prefix}new > انشاء تـــكـــت

${prefix}close > حذف تـــكـــت

${prefix}say > انشاء رد تلقائي خاص بسيرفرك

${prefix}move > تحريك العضو

${prefix}replay > اعادة ما اقول

${prefix}setLog >  وضع لوقز في الروم

${prefix}setby >  وضع راسالة توديع

${prefix}setWelcomer <channel name> >  وضع صورة عند دخول العضو

${prefix}setMessage >  وضع راساله عند دخول العضو

${prefix}setVc <channel Name> > رؤية المتصيل بالدردشة الصوتية

${prefix}vc off > اخفاء المتصلين بالدردشة الصوتية

${prefix}ls > رؤية جميع البوتات

${prefix}role > اعطاء عضو مخصص رتبه مخصصة

${prefix}bc > ارسال برودكاست في خاص الاعضاء

${prefix}role all > اعطاء جميع الاعضاء رتبة مخصصة

**|  Commands Submits  |**


${prefix}room1 >  انشاء روم تقديمات

${prefix}room2 >  انشاء روم قبول ورفض التقديمات


${prefix}قبول @اسمه

${prefix}رفض @اسمه السب
`
        )
        .then(() => {
          message.author.send(`
...
${prefix}Money > رؤية نقودك

${prefix}daily > اخذ نقود كل 24 ساعه مجانا

**|  Music Command  |**
 
${prefix}Play :[${prefix}p] > تشغيل الموسيقى
 
${prefix}Pause  > ايقاف الموسيقى

${prefix}Resume > استئناف الموسيقى

${prefix}stop > ايقاف الموسيقى مؤقتا
 
${prefix}forceskip 
 
${prefix}Queue > رؤية الاغاني التي في الطابور
 
${prefix}skipto > التخطي الى الاغنية التي تريدها
 
${prefix}Skip :[-s] > التخطي الى الموسيقي الاخرى

${prefix}Volume >تغير الصوت
 
${prefix}Nowplaying :[-np] > ماهي الاغنية الحالية
 
${prefix}repeat > اعادة الاغنية

${prefix}Leave > اخراج البت من الروم الصوتي
...
${prefix}settings limitstime > يحدد وقت للباند مثلا شخص بند 5 في الوقت الي حددته ياخذ باند

-antibots on > يمنع دخول البوتات الى سيرفرك

-antibots off > يسمح للبوتات بدخول سيرفرك
=========================================================
**| Invite Bot |**

**Owenr Bot:**[ <@748065198333755423> ]

**invite Bot:**[<https://discord.com/api/oauth2/authorize?client_id=768398291725189120&permissions=8&scope=bot>]

**WebSite:**[https://5f8876629af5e.site123.me/]

**Server Support:**[<https://discord.gg/sF8AuDf>]
                              
**Invite Bot Top.gg**[<https://top.gg/Bot/768398291725189120>]
...
${prefix}colors >  غير مفعل

${prefix}color >غير مفعل
...
client.on("message", message => {
  if (message.content === "-inv") {
    ...
    message.channel.sendFile("Link Bot");
  }
});


client.on("message", message => {
  if (message.content === "UFC EA SPORT") {
    message.channel.send("YT YaSer FOr Evere");
    message.channel.sendFile("Link Bot");
  }
});
...
/////https://discord.com/api/oauth2/authorize?client_id=768398291725189120&permissions=8&scope=bot
...
client.on("message", message => {
  if (message.content.includes("ل.عن")) {
    if (message.member.hasPermission("ADMINISTRATOR")) return;
    message.delete();
    message.guild
      .member(message.author)
    ...
    let embedP = new Discord.RichEmbed()
      ...
      .setAuthor(message.author.username, message.author.avatarURL)
      .addField(
        `** لقد قمت بمخالفة قوانين السيرفر من خلال شتم احد الاعضاء  **`,
        `**ملاحظة  : إن كآن هذآ الاسكات عن طريق الخطأ الرجاء التوجه والتكلم مع الادآرة**`
      )
...
client.on("message", message => {
  if (message.content.includes("لعن")) {
    if (message.member.hasPermission("ADMINISTRATOR")) return;
    message.delete();
    message.guild
      .member(message.author)
...
client.on("message", message => {
  if (message.content.includes("تفو")) {
    ...
    message.guild
      .member(message.author)
      .addRole(message.guild.roles.find(r => r.name === "تفال"));
    let embedP = new Discord.RichEmbed()
      .setTitle("انت مو محترم")
      .setAuthor(message.author.username, message.author.avatarURL)
      .addField(
        `** لاتتفل يا ولد مرة ثانية **`,
      )
      .setColor("RED")
      .setThumbnail(message.author.avatarURL)
      .setFooter(`${message.guild.name} Server`, message.guild.iconURL);
...
client.on("message", message => {
  if (message.content.includes("يلعنك")) {
    ...
    let embedP = new Discord.RichEmbed()
      ...
      .setAuthor(message.author.username, message.author.avatarURL)
      .addField(
        `** لقد قمت بمخالفة قوانين السيرفر من خلال شتم احد اعضاء السيرفر  **`,
        `**ملاحظة  : إن كآن هذآ الاسكات عن طريق الخطأ الرجاء التوجه والتكلم مع الادآرة**`
      )
